...
Passos:
    Escrever a função de operações soma, subtração, multiplicação e divisão
    Criar laço de repetição While (true)
    Criar condicionais para filtrar as opções do usuário: 1 a 4 (operações matemáticas), 0 (break) e qualquer outro valor (mensagem de erro)
    '''
